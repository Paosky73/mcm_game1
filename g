...
lifetime = int(read[1])
file.close()
image = pygame.image.load('paofinal.png')
...
def draw_screen(line_list, lase):
    ...
    top = pygame.draw.rect(screen, 'purple', [0, 0, WIDTH, 50])
    bot = pygame.draw.rect(screen, 'light green', [0, HEIGHT - 50, WIDTH, 50])
...
def draw_player():
    ...
    if player_y < init_y or pause:
        ...
        pygame.draw.rect(screen, '#FF5733', [128, player_y + 60, 10, 20], 0, 3)
        pygame.draw.rect(screen, 'yellow', [130, player_y + 60, 10, 20], 0, 3)
    else:
        if counter < 10:
            pygame.draw.line(screen, '#FF5733', (128, player_y + 60), (140, player_y + 80), 10)
            pygame.draw.line(screen, 'yellow', (130, player_y + 60), (120, player_y + 80), 10)
        elif 10 <= counter < 20:
            pygame.draw.rect(screen, '#FF5733', [128, player_y + 60, 10, 20], 0, 3)
            pygame.draw.rect(screen, 'yellow', [130, player_y + 60, 10, 20], 0, 3)
        elif 20 <= counter < 30:
            pygame.draw.line(screen, '#FF5733', (128, player_y + 60), (120, player_y + 80), 10)
            pygame.draw.line(screen, 'yellow', (130, player_y + 60), (140, player_y + 80), 10)
        else:
            pygame.draw.rect(screen, '#FF5733', [128, player_y + 60, 10, 20], 0, 3)
            pygame.draw.rect(screen, 'yellow', [130, player_y + 60, 10, 20], 0, 3)
    # jetpack, body and head
    pygame.draw.ellipse(screen, 'khaki', [120, player_y + 20, 30, 50])
    pygame.draw.rect(screen, 'yellow', [133, player_y -2, 10, 5])
    pygame.draw.ellipse(screen, 'white', [125,player_y + -3, 20, 20], 10 )
    pygame.draw.circle(screen, 'brown', (135, player_y + 15), 10)
    pygame.draw.circle(screen, 'black', (140, player_y + 14), 3)
    pygame.draw.rect(screen, 'light blue', [100, player_y + 24, 20, 30], 0, 5)
    pygame.draw.rect(screen, 'white', [125, player_y + 3, 25, 5], 0, 5)
    pygame.draw.line(screen, 'black', (125, player_y + 9), (125, player_y + 4), 2)
    pygame.draw.line(screen, 'black', (145, player_y + 9), (145, player_y + 4), 2)

    #minor details
    pygame.draw.rect(screen, 'brown', [129, player_y + 29, 7,22], 0, 5)
    pygame.draw.rect(screen, 'red', [125, player_y + 22, 20,5])
    pygame.draw.rect(screen, 'red', [127, player_y + 20, 10,5])
    pygame.draw.ellipse(screen, 'orange', [140, player_y + 29, 7,26],  35)
    pygame.draw.ellipse(screen, 'orange', [121, player_y + 29, 7,32], 25)
    pygame.draw.ellipse(screen, 'white', [141, player_y + 32, 2, 19], 4)
    pygame.draw.ellipse(screen, 'white', [123, player_y + 32, 2, 25], 3)
...
def draw_pause():
    size = pygame.transform.scale(image, (300, 300))
    screen.blit(size, (350, 150))
    pygame.draw.rect(surface, (128, 128, 128, 150), [0, 0, WIDTH, HEIGHT])
    pygame.draw.rect(surface, 'dark gray', [200, 150, 600, 50], 0, 10)
    surface.blit(font.render('Game Pause    d. Escape Btn Resumes', True, 'black'), (220, 160))
...
while run:
    ...
    #restart_cmd = Main Menu(needs new code)
